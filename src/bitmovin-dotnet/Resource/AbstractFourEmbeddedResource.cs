...
{
    public class AbstractFourEmbeddedResource<T>
    {
        protected RestClient _restClient;

        protected string _url;

        public AbstractFourEmbeddedResource(RestClient client, string url)
        {
        ...
        public List<T> RetrieveAllIterative(string id, string sub_id, string sub_sub_id, string sub_sub_sub_id,
            int offset, int limit)
        {
            var retrieveUrl = string.Format(_url + "?offset={4}&limit={5}", id, sub_id, sub_sub_id, sub_sub_sub_id,
                offset, limit);
        ...
        public T Create(string id, string sub_id, string sub_sub_id, string sub_sub_sub_id, T item)
        {
            var postUrl = string.Format(_url, id, sub_id, sub_sub_id, sub_sub_sub_id);
            return _restClient.Post<T>(postUrl, item);
        }

        public T Retrieve(string id, string sub_id, string sub_sub_id, string sub_sub_sub_id, string sub_sub_sub_sub_id)
        {
            var retrieveUrl = string.Format(_url + "/{4}", id, sub_id, sub_sub_id, sub_sub_sub_id,
                sub_sub_sub_sub_id);
