...
namespace com.bitmovin.Api.Examples
{
    ...
    [TestClass]
    public class EncodingWithFtpInputAndFtpOutput
    {

        private const string API_KEY = "YOUR API KEY";

        private const string FTP_INPUT_HOST = "YOUR FTP INPUT HOST";
        private const string FTP_INPUT_USERNAME = "YOUR FTP INPUT USERNAME";
        private const string FTP_INPUT_PASSWORD = "YOUR FTP INPUT PASSWORD";
        private const string FTP_INPUT_PATH = "path/to/your/input";
        ...
        public void StartVodEncoding()
        {
            ...
            var input = bitmovin.Input.Ftp.Create(new FtpInput
            { 
                Name = "FTP Input",
                Host = FTP_INPUT_HOST,
                Username = FTP_INPUT_USERNAME,
                Password = FTP_INPUT_PASSWORD
            });
            ...
            var videoStream1080p = bitmovin.Encoding.Encoding.Stream.Create(encoding.Id,
                CreateStream(input, FTP_INPUT_PATH, 0, videoConfig1080p, SelectionMode.VIDEO_RELATIVE));
            ...
            var videoStream720p = bitmovin.Encoding.Encoding.Stream.Create(encoding.Id,
                CreateStream(input, FTP_INPUT_PATH, 0, videoConfig720p, SelectionMode.VIDEO_RELATIVE));
            ...
            var videoStream480p = bitmovin.Encoding.Encoding.Stream.Create(encoding.Id,
                CreateStream(input, FTP_INPUT_PATH, 0, videoConfig480p, SelectionMode.VIDEO_RELATIVE));
            ...
            var videoStream360p = bitmovin.Encoding.Encoding.Stream.Create(encoding.Id,
                CreateStream(input, FTP_INPUT_PATH, 0, videoConfig360p, SelectionMode.VIDEO_RELATIVE));
            ...
            var videoStream240p = bitmovin.Encoding.Encoding.Stream.Create(encoding.Id,
                CreateStream(input, FTP_INPUT_PATH, 0, videoConfig240p, SelectionMode.VIDEO_RELATIVE));
            ...
            var audioStream = bitmovin.Encoding.Encoding.Stream.Create(encoding.Id,
                CreateStream(input, FTP_INPUT_PATH, 0, audioConfig, SelectionMode.AUDIO_RELATIVE));
        ...
        private static Stream CreateStream(BaseObject input, string inputPath, int? position,
